...
public final class findPassword_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath4left = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath();   
      ...
      out.write("\t\t\t         <li><a href=\"");
      out.print(basePath );
      out.write("/index\">Home</a> <span class=\"divider\">&gt;&gt; Forgot your password?</span></li>\n");
      out.write("\t\t\t    </ul>\n");
      out.write("\t            <h4><font color=\"orange\">Forgot your password?</font></h4>\n");
      out.write("\t          \t<hr>\n");
      out.write("    \t\t  \t<div>\n");
      out.write("\t\t\t\t\t  <font color=\"red\"><span id=\"email-help\">");
      ...
      out.write("</span></font>\n");
      out.write("\t\t\t\t\t  <form id=\"findMyPasswordForm\" class=\"form-search\" action=\"");
      out.print(basePath );
      out.write("/member/findMyPassword\" method=\"post\">\n");
      out.write("\t\t\t\t\t  \t  <div class=\"row\">\n");
      out.write("\t\t\t\t\t  \t       <span class=\"col-lg-2\">Email Address:</span>\n");
      out.write("\t\t\t\t\t  \t       <div class=\"col-lg-4\">\n");
      out.write("\t\t\t\t\t  \t         <input class=\"form-control input-sm\" type=\"text\" id=\"email\" name=\"email\" class=\"input-large\">\n");
      out.write("\t\t\t\t\t  \t       </div>\n");
      out.write("\t\t\t\t\t  \t       <div class=\"col-lg-3\">\n");
      out.write("\t\t\t\t\t  \t         <img alt=\"\" src=\"");
      out.print(basePath);
      out.write("/assets/icos/product/btnSubmit.jpg\" onclick=\"javascript:submitEmail();\">\n");
      out.write("\t\t\t\t\t  \t       </div>\n");
      out.write("\t\t\t\t\t  \t  </div>\n");
      out.write("\t\t\t\t\t  </form>\n");
      out.write("    \t\t  \t</div>\n");
      ...
      out.write("\t    if(email == \"\"){\n");
      out.write("\t\t   \t $(\"#email-help\").html(\"<i class='icon-remove'></i>email can not be null\");\n");
      out.write("\t\t   \treturn false;\n");
      out.write("\t    }\n");
      out.write("\t    $(\"#findMyPasswordForm\").submit();\n");
