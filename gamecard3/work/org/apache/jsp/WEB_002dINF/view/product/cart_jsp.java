...
static {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath4footcustomerlike = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath();   
      ...
      out.write("    \n");
      out.write(" \t\n");
      out.write("     //参数说明 单价，id \n");
      out.write("    function  amountChange(unitPrice,id){\n");
      out.write("    \t\n");
      out.write("    \t var obj = document.getElementById(\"item_amount_\"+id); //定位id \n");
      out.write("    \t var index = obj.selectedIndex; // 选中索引 \n");
      out.write("    \t var value = obj.options[index].value; // 选中值 \n");
      ...
      out.write("    \t \n");
      out.write("    \t //每次change计算总金额  计算公式：原总金额 +（现单价总金额-原单价总金额）\n");
      ...
      out.write("    \t //判断是否有购物车记录  判断总金额是否为0\n");
      out.write("    \t var totalPrice =document.getElementById(\"totalPrice\").innerHTML ;\n");
      ...
      out.write("\t \t\t    \t\t  //需要传递的参数 ：1：productId  2：amount 3:shopItemId 购物车编号  4:折扣码 \n");
      ...
      out.write("     }\n");
      out.write("     \n");
      out.write("\t\t//计算相加   参数是div里的innerHTML \n");
      ...
      out.write("    \t}\n");
      out.write("  //对小数做处理 如果大于两位小数 则截取两位小数 \n");
