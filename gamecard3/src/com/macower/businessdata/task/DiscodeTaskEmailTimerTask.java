...
public class DiscodeTaskEmailTimerTask extends TimerTask{
	...
	public DiscodeTaskEmailTimerTask(Integer dataRows,Long taskId,String subject,String emailTpl,String hostEmail ,String hostPassword){
		super() ;
