...
public class MemberTimerTask extends TimerTask{
	...
	public MemberTimerTask(Integer dataRows,Long taskId,String subject,String emailTpl,String hostEmail ,String hostPassword){
		super() ;
