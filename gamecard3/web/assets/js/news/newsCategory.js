Ext.onReady(function(){
	...
	var editForm = new Ext.form.FormPanel({region:"center",autoHeight:false,frame:true,fileUpload:false,height:200,width:300,timeout:300 
		,layout:"form"
		,items: [{
					xtype:"hidden",
					name:"id"
