Ext.onReady(function(){
	...
	var queryForm_atrr_1 = new Ext.form.TextField({width:150,name:"brand",fieldLabel:"品牌"});
	...
	var gridPanel = new Ext.grid.GridPanel(
			...
			cm: new Ext.grid.ColumnModel([
			                              ...
			                              {header:"品牌名称",width:200,dataIndex:"brand"}
			                              ])
	});
	...
	var editForm = new Ext.form.FormPanel({region:"center",height:200,frame:true,fileUpload:false,autoWidth:true,timeout:300
		,items: [
			new Ext.Panel({layout:"column",
				items: [
					new Ext.Panel({width:300,layout:"form",items: [editForm_atrr_1,editForm_atrr_2]})
				]
			})
		]
	});
