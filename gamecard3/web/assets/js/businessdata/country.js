Ext.onReady(function(){
	...
	var gridPanel = new Ext.grid.GridPanel(
			...
			cm: new Ext.grid.ColumnModel([
			                              ...
			                              {header:"编码",width:300,dataIndex:"code"},
			                              {header:"国家名称",width:300,dataIndex:"country"}
			                              ])
	});
	...
	var editForm_atrr_1 = new Ext.form.TextField({width:150,name:"code",maxLength:30,allowBlank:false,fieldLabel:"参数名",labelSeparator:'<font color=red>*</font>'});
	var editForm_atrr_2 = new Ext.form.TextField({width:150,name:"country",maxLength:30,allowBlank:false,fieldLabel:"参数代码",labelSeparator:'<font color=red>*</font>'});
	
	var editForm_atrr_3 = new Ext.form.Hidden({name:"id"});
	
	
	var editForm = new Ext.form.FormPanel({region:"center",frame:true,fileUpload:false,autoWidth:true,timeout:300
		,items: [
