...
SF.claim.assess.PersonalHirerForm = Ext.extend(Ext.form.FormPanel,{
	width:764,
	constructor : function(config){
		...
		SF.claim.assess.PersonalHirerForm.superclass.constructor.call(this,config);
	}
});

Ext.reg('SF.claim.assess.personalHirerForm',SF.claim.assess.PersonalHirerForm);
