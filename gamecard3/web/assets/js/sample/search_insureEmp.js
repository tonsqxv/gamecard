...
Ext.onReady(function() {
			...
			var queryForm_atrr_1 = new Ext.form.DateField({width:125,name:"caseEmp.caseObject.reportTmBegin",format:"Y-m-d",value:pretoday(15),fieldLabel:"上报时间（开始）"});

			var queryForm_atrr_2 = new Ext.form.DateField({width:125,name:"caseEmp.caseObject.reportTmEnd",format:"Y-m-d",value:new Date(),fieldLabel:"上报时间（结束）"});

			var queryForm_atrr_3 = new Ext.form.ComboBox({hiddenName:"caseEmp.caseObject.caseLevel",store:new Ext.data.SimpleStore({data: [['','全部'],['1','一级'],['2','二级'],['3','三级'],['4','四级'],['5','五级']], fields: ['key','value']}),valueField:"key",displayField:"value",width:125,triggerAction:"all",emptyText : '全部',fieldLabel:"案件级别",editable:false,mode:"local"});

			var queryForm_atrr_4 = new Ext.form.ComboBox({hiddenName:"caseEmp.caseObject.status",store:new Ext.data.SimpleStore({data: [['','全部'],['1','新增'],['2','上报'],['3','处理'],['4','完结'],['5','评估']], fields: ['key','value']}),valueField:"key",displayField:"value",width:125,triggerAction:"all",emptyText : '全部',fieldLabel:"状态",editable:false,mode:"local"});

			var queryForm_atrr_5 = new Ext.form.TextField({width:125,name:"caseEmp.caseId",fieldLabel:"案件工单号"});
			
			var queryForm_atrr_6 = new Ext.form.TextField({width:125,name:"caseEmp.caseObject.eventId",fieldLabel:"事件工单号"});
				...
				buttons: [
				          	{text:"确定",iconCls:'revert',handler:function(){
				          		...
				          		authorizedDepartment(selectDeptNode.id,function(){
				          			queryForm.getForm().findField("caseEmp.caseObject.reportDeptName").setValue(selectDeptNode.text);
				          			queryForm.getForm().findField("caseEmp.caseObject.reportDept").setValue(selectDeptNode.id);
				          			selectDeptWin.hide() ;
			...
			var queryForm_atrr_7 = new Ext.form.TriggerField({
									width:125,
									name:"caseEmp.caseObject.reportDeptName",
									fieldLabel:"上报地区/部门",
			...
			var queryForm_atrr_8 = new Ext.form.ComboBox({hiddenName:"caseEmp.isContainSubDept",store:new Ext.data.SimpleStore({data: [['1','包含'],['2','不包含']], fields: ['key','value']}),valueField:"key",displayField:"value",value:"1",width:125,triggerAction:"all",fieldLabel:"所辖网点",editable:false,mode:"local"});

			var queryForm_atrr_9 = new Ext.form.TextField({width:125,name:"caseEmp.empCode",fieldLabel:"工号"});
			
			var queryForm_atrr_10 = new Ext.form.TextField({width:125,name:"caseEmp.empName",fieldLabel:"姓名"});
			
			var queryForm_atrr_11 = new Ext.form.TextField({width:125,name:"caseEmp.idcard",fieldLabel:"身份证号"});
			
			var queryForm_atrr_12 = new Ext.form.ComboBox({hiddenName:"caseEmp.caseSection",store:new Ext.data.SimpleStore({data: [['','全部'],['1','6:00-14:00'],['2','14:01-22:00'],['3','22:01-5:59']], fields: ['key','value']}),valueField:"key",displayField:"value",width:125,triggerAction:"all",emptyText : '全部',fieldLabel:"出险时间段",editable:false,mode:"local"});

			var queryForm_atrr_13 = new Ext.form.ComboBox({hiddenName:"caseEmp.accidentType",store:new Ext.data.SimpleStore({
			...
			var queryForm_atrr_14 = new Ext.form.ComboBox({hiddenName:"caseEmp.casePoint",store:new Ext.data.SimpleStore({data: [['','全部'],['1','上班途中'],['2','下班途中'],['3','工作地点'],['4','家中'],['5','其它']], fields: ['key','value']}),valueField:"key",displayField:"value",width:125,triggerAction:"all",emptyText : '全部',fieldLabel:"出险地点",editable:false,mode:"local"});
			var queryForm_atrr_15 = new Ext.form.Hidden({name:"caseEmp.caseObject.reportDept"});
				...
				items : [
						{
							region : 'center',
							tbar : [ '-'
							        <app:isPermission code="/claim/searchInsureEmpSearch.action">
							        ,new Ext.Button({text:"查询",iconCls:'search',handler:onSearch })
							        </app:isPermission>
							        ,new Ext.Button({text:"查看",iconCls:'detail',handler:onDetail }) 
							        <app:isPermission code="/claim/searchInsureEmpExport.action">
			...
			function onExport() {
					...
					Ext.Ajax.request({
						...
						method :"POST",
						url: "caseEmp_exportValidate.action",
						success: function(response) {
							var resp = Ext.util.JSON.decode(response.responseText);
							if (resp.success) {
								queryForm.getForm().doAction('submit', {
									url : "exportCaseEmp.action",
