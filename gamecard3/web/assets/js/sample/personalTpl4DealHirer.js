...
SF.claim.deal.PersonalHirerForm = Ext.extend(Ext.form.FormPanel,{
	width:790,
	constructor : function(config){
		...
		SF.claim.deal.PersonalHirerForm.superclass.constructor.call(this,config);
	}
});

Ext.reg('SF.claim.deal.personalHirerForm',SF.claim.deal.PersonalHirerForm);
