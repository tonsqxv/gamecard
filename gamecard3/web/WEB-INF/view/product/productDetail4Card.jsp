      ...
      <div class="row">
          ...
          <hr>    		
              ...
              <div class="col-lg-8">
	                ...
	                <div>
		                  <div class="col-lg-3"><p class="text-right"><strong>Brand:</strong></p></div>
		                  <div class="col-lg-9"><p class="text-left"><a onclick="javascript:window.open('http://${product.brand }')" >${product.brand }</a></p></div>
	                </div>
	                <div>
