      ...
      <div class="row-fluid">
          ...
          <hr>    		
              ...
              <div class="span8">
	                ...
	                <div>
		                  <div class="span3"><p class="text-right"><strong>Brand:</strong></p></div>
		                  <div class="span9"><p class="text-left"><a onclick="javascript:window.open('http://${product.brand }')" >${product.brand }</a></p></div>
	                </div>
	                <div>
