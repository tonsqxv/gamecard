...
<title></title>
	...
	<script type="text/javascript" src="<%=basePath %>/assets/js/common/checkTreeExtend.js"></script>
	<script type="text/javascript" src="<%=basePath %>/assets/js/common/util.js"></script>
	
	<!-- my js file -->
	<script type="text/javascript" src="<%=basePath %>/assets/js/sys/role.js"></script>
